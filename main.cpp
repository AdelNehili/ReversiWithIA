...
int main()
{
	...
	*/
	...
	int weight[8][8] = 	{{8, -7, 2, 2, 2, 2, -7, 8},
						{-7, -8, -1, -1, -1, -1, -8, -7},
						{2, -1, 1, 0, 0, 1, -1, 2},
						{2, -1, 0, 1, 1, 0, -1, 2},
						{2, -1, 0, 1, 1, 0, -1, 2},
	...
	ofstream * po;
	ofstream fichier_out_noir(nom_fichier_noir);
	ofstream fichier_out_blanc(nom_fichier_blanc);
	ifstream * pi;
	ifstream fichier_in_noir(nom_fichier_noir);
	ifstream fichier_in_blanc(nom_fichier_blanc);
